...
from nlp_ood_detection.data_depth.similarity_scorer import ScorerInput
...
def main():
    ...
    energy_parser.add_argument(
        r'--temperature', dest=r'T', help=r'Temperature', default=1, type=float)
    ...
    model_input: ScorerInput = {
        "x_test": x_grid,
        "x_train": x_train,
        "y_train": y_train,
    }
    score = scorer.score(model_input)
